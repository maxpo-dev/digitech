        ...
        <div className="w-full flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 text-center md:text-left text-white space-y-6">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              ...
              <a
                href="https://www.google.com/maps/place/Pullman+Kuala+Lumpur+City+Centre+Hotel+%26+Residences/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center bg-white bg-opacity-20 backdrop-blur-sm rounded-lg px-6 py-3 shadow-md hover:bg-opacity-30 transition"
              >
            ...
            <div className="mt-6">
              <Link
                href="/contact"
                className="inline-block bg-gradient-to-r from-pink-500 to-yellow-500 text-white text-lg font-semibold py-3 px-10 md:px-12 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300"
              >
                Register Now
              </Link>
            </div>
